...
export type GetBoardsAndLanesAndCardsQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetBoardsAndLanesAndCardsQuery = {
  __typename?: "Query";
  boardCollection?: {
    __typename?: "boardConnection";
    edges: Array<{
          ...
          edges: Array<{
            ...
            node: {
              ...
              cardCollection?: {
                ...
                edges: Array<{
                  __typename?: "cardEdge";
                  node: { __typename?: "card"; id: any; title: string };
                }>;
              } | null;
            };
          }>;
...
export type BoardsQuery = {
  ...
  boardCollection?: {
    ...
    edges: Array<{
      __typename?: "boardEdge";
      node: { __typename?: "board"; id: any; title: string };
    }>;
  } | null;
};

export const GetBoardsAndLanesAndCardsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getBoardsAndLanesAndCards" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "boardCollection" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                {
                    ...
                    selections: [
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "laneCollection" },
                              selectionSet: {
                                kind: "SelectionSet",
                                selections: [
                                  {
  ...
  GetBoardsAndLanesAndCardsQuery,
  GetBoardsAndLanesAndCardsQueryVariables
>;
